...
TEACHER_PEFT_CKPT_NAME="sft/qwen2.5-7B-it/dolly/qwen-prompt/e8-bs2-lr2e-05-G8-N4-NN1-lora-8-16-0.1/20260519_065458/1068"
TEACHER_PEFT_CKPT="/media/drive2/distillation/safety-utility-pg/results/qwen2/train/sft/qwen2.5-7B-it/dolly/qwen-prompt/e8-bs2-lr2e-05-G8-N4-NN1-lora-8-16-0.1/20260519_065458/1068"
...
WANDB_RUN_NAME="rkl_3B_7B_teacher_qwen_student_qwen_for_dolly_dataset"
KD_RATIO=0.5 
...
# runtime
SAVE_PATH="${DRIVE_PATH}/results/qwen2/train/${TYPE}/chat/7-3B/dolly/qwen-prompt/${KD_RATIO}"
