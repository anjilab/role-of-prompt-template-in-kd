...
CKPT_NAME=${4-"qwen-7B"}
CKPT=${5-"/media/drive2/models/qwen-models/Qwen2.5-7B-Instruct"}
PEFT_CKPT_NAME=${2}
PEFT_CKPT=${3}
...
# hp
EVAL_BATCH_SIZE=${EVAL_BATCH_SIZE_OVERRIDE:-4}
...
SAVE_PATH=${SAVE_PATH_OVERRIDE:-"${DRIVE_PATH}/results/qwen2/eval_main/base/qwen-prompt"}
