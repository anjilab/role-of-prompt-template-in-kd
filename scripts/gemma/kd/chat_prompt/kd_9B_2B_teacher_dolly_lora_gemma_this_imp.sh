...
# Teacher=Gemma Prompt and KD= gemma prompt
...
# Teacher=Dolly prompt and KD = gemma prompt
...
# runtime
# SAVE_PATH="${BASE_PATH}/results/llama2/train/kd/7-1B/dolly-prompt/0.5"
# SAVE_PATH="${BASE_PATH}/results/llama2/train/kd/7-1B/dolly-prompt/1"
