...
CKPT="/media/drive2/models/gemma-models/gemma-2-2b"
...
# Student = Gemma prompt Chat prompt and Teacher prompt = Task prompt (Non-chat prompt)
...
# MP_SIZE=4
# data
DATA_DIR="${BASE_PATH}/processed_data/gemma2/dolly/full/gemma2-chat"
# hp
...
TYPE="kd" # For kd, feb 10 exptX
# TYPE="rkl" # For kd, feb 10 exptX
# TYPE="fkl+rkl" # For fkl+rkl, feb 18 expt
# WANDB_RUN_NAME="gemma_kd_3B_8B_teacher_dolly_lora_fkl_basemodels"
WANDB_RUN_NAME="gemma_kd_3B_8B_teacher_dolly_lora_student_gemma_teacher_criscross_evaluation"

# TYPE="jsd" # For jsd, feb 25 expt
# WANDB_RUN_NAME="gemma_kd_2B_9B_teacher_gemma_lora_gemma_prompting_kd_ratio_1_0"

KD_RATIO=0.5
# KD_RATIO=1.0 # For RKL, with 1.0, feb 12 expt, fOR kd, WITH 1.0 FEB 13 EXPT
...
# runtime
# SAVE_PATH="${DRIVE_PATH}/results/gemma2/train/kd/chat/9-2B/gemma-prompt/${TYPE}/${KD_RATIO}"
SAVE_PATH="${DRIVE_PATH}/results/gemma2/train/kd/without_it_student_models/9-2B/gemma-prompt/teacher-criscross-evaluation/${TYPE}/${KD_RATIO}"
