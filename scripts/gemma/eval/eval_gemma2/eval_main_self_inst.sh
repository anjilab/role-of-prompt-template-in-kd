...
DATA_DIR="${BASE_PATH}/processed_data/gemma2/self-inst/full/gemma2-chat"

# hp
EVAL_BATCH_SIZE=${EVAL_BATCH_SIZE_OVERRIDE:-1}
# runtime
SAVE_PATH=${SAVE_PATH_OVERRIDE:-"${DRIVE_PATH}/results/gemma2/eval_main/kd/8-2B/gemma-prompt"}
# SAVE_PATH="${DRIVE_PATH}/results/gemma2/eval_main/sft/9B/gemma-prompt"
# SAVE_PATH="${DRIVE_PATH}/results/gemma2/eval_main/sft/2B/gemma-prompt"
